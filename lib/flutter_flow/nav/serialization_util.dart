    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case DentistRow:
            return DentistRow(data);
          case DentistAvailabilityRow:
            return DentistAvailabilityRow(data);
          case HistoryRow:
            return HistoryRow(data);
          case LeaveRequestRow:
            return LeaveRequestRow(data);
