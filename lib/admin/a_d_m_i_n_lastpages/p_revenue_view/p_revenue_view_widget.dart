...
import 'p_revenue_view_model.dart';
export 'p_revenue_view_model.dart';

class PRevenueViewWidget extends StatefulWidget {
  const PRevenueViewWidget({super.key});

  static String routeName = 'P_RevenueView';
  static String routePath = '/pRevenueView';

  @override
  State<PRevenueViewWidget> createState() => _PRevenueViewWidgetState();
}

class _PRevenueViewWidgetState extends State<PRevenueViewWidget> {
  late PRevenueViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PRevenueViewModel());
    _model.choiceChipsValueController = FormFieldController<List<String>>(['1M']);

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.revenueData = await actions.getMonthlyRevenueMetrics(filterType: '1M');
      _model.localRevenueList = _model.revenueData!.toList().cast<dynamic>();
      safeSetState(() {});
    });
  }
                ...
                onPressed: () async {
                  await showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: Text(
                        'View the clinic\'s revenue analytics over different time periods (7 days, 1 month, 3 months, 6 months, or all time). Click the Export button to export revenue reports.',
                      ...
                      Padding(
                        ...
                        child: FlutterFlowChoiceChips(
                          ...
                          onChanged: (val) async {
                            ...
                            _model.revenueData = await actions
                                .getMonthlyRevenueMetrics(
                                    filterType: _model.choiceChipsValue);
                            _model.localRevenueList = _model.revenueData!
                                .toList()
                                .cast<dynamic>();
                            safeSetState(() {});
                          },
                            ...
                            children: [
                              ...
                              Text(
                                valueOrDefault<String>(
                                  functions.calculateTotalRevenue(
                                      _model.localRevenueList.toList()),
                                  '000,000',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .headlineLarge
                                    ...
                                    children: [
                                      TextSpan(
                                        text: valueOrDefault<String>(
                                          functions.calculateTargetPercentage(
                                              _model.localRevenueList.toList()),
                                          '25',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            LinearPercentIndicator(
                                              ...
                                              animation: true,
                                              animateFromLastPercent: true,
                                              progressColor: Color(0xFFFA8231),
                                              backgroundColor:
                                                  FlutterFlowTheme.of(context)
                                                      .alternate,
                                              barRadius: Radius.circular(4.0),
