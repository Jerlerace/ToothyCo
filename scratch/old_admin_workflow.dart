                                              ...
                                              Text(
                                                () {
                                                  ...
                                                  if (monthlyRevenue < 1000) {
                                                    ...
                                                    return '\$${(monthlyRevenue / 1000).toStringAsFixed(1)}K';
                                                  }
                                                }(),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                () {
                                                  final completedAppts = appointments.where((a) => a.status == 'Completed' || a.status == 'Attended').length;
                                                  final totalAppts = appointments.length;
                                                  final rate = totalAppts == 0 ? 0.0 : (completedAppts / totalAppts) * 100;
